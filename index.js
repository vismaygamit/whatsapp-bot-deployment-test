...
client.on('message', async msg => {
    ...
    const msgBody = msg.body.toLocaleLowerCase();
    if (msgBody.includes('hbd') || msgBody.includes('happy birthday') || msgBody.includes('happy b\'day') || msgBody.includes('happy returns of the day')) {
